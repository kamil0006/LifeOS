export const learningFieldClass =
  'w-full rounded-lg border border-(--border) bg-(--bg-dark) px-3 py-2.5 text-base text-(--text-primary) focus:border-(--accent)/50 focus:outline-none focus:ring-1 focus:ring-(--accent)/25'
...
export const learningPrimaryBtnClass =
  'flex w-full items-center justify-center gap-2 rounded-lg border border-(--accent)/40 bg-(--accent)/15 px-4 py-3 text-base font-medium text-(--accent) transition-colors hover:bg-(--accent)/25 disabled:opacity-50 sm:w-auto sm:py-2'
...
export const learningAddBtnClass =
  'flex min-h-11 items-center gap-2 rounded-lg border border-(--accent)/40 bg-(--accent)/15 px-4 py-2 text-base font-medium text-(--accent) transition-colors hover:bg-(--accent)/25'
